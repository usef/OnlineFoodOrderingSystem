...
<html lang="en">
<head>
    <title>Staple Food a Restaurants Category Bootstrap Responsive website Template | Terms & Conditions ::
        w3layouts</title>
    ...
    <div class="container">
        ...
        <div class="privacy-w3row">
            ...
            <p>Pellentesque quis sagittis est. Nam placerat ante at nunc ornare, sed faucibus odio interdum. Nam
                viverra, purus ac ullamcorper convallis, lorem erat consequat enim, at pharetra magna. </p>
    ...
    <div class="container">
        <div class="w3_footer_grids">
            ...
            <div class="col-xs-6 col-sm-3 footer-grids w3-agileits">
                <h3>Menu</h3>
                <ul>
                    <li><a href="restaurants.php">All Day Menu</a></li>
                    <li><a href="restaurants.php">Lunch</a></li>
                    <li><a href="restaurants.php">Dinner</a></li>
                    <li><a href="restaurants.php">Flavours</a></li>
                </ul>
            </div>
            <div class="clearfix"></div>
        </div>
