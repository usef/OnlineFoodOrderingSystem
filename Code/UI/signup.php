...
if (isset($_POST['submit'])) {
    if (($_POST['password'] == $_POST['confirmpassword'])) {
        ...
        if ($user->register()) {
            $message = '<div class="alert alert-success" role="alert">Please check your mail for an activation link.</div>';
            header("refresh:5; url=login.php"); //wait for 5 seconds before redirecting
        } else {
            $message = '<div class="alert alert-danger" role="alert">You already have an account, please login instead.</div>';
            header("refresh:5; url=login.php"); //wait for 5 seconds before redirecting
        }
    } else {
        $message = '<div class="alert alert-danger" role="alert">Your passwords mismatch, please enter it again.</div>';
    }
}
    ...
    <div class="container">
        ...
        <div class="login-agileinfo">
            ...
            <form action="#" method="post">
                <input class="agile-ltext" type="text" name="fname" placeholder="First Name" required="">
                <input class="agile-ltext" type="text" name="lname" placeholder="Last Name" required="">
                ...
                <input class="agile-ltext" type="password" name="confirmpassword" placeholder="Confirm Password"
                       required="">
